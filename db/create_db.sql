CREATE TABLE `bid` (
  `bid_id` varchar(10) NOT NULL COMMENT 'Bid ID',
  `project_id` varchar(10) NOT NULL COMMENT 'Project ID of the project for which this bid is put',
  ...
  `bid_hours` int(11) DEFAULT '0' COMMENT 'If bid type is hourly, this is needed to calculate bid amount',
...
CREATE TABLE `buyer` (
  ...
  `location` varchar(45) DEFAULT 'None' COMMENT 'Location of the buyer',
  `skills` varchar(45) DEFAULT 'None' COMMENT 'Skills of the buyer',
  `creation_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Datetime when the buyer was created',
  PRIMARY KEY (`buyer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `project` (
  `project_id` varchar(10) NOT NULL COMMENT 'Project ID',
  `project_name` varchar(45) NOT NULL COMMENT 'Name of the project',
  `location` varchar(45) DEFAULT 'None' COMMENT 'Location specified for the project',
  ...
  `buyer_id` varchar(45) DEFAULT 'None' COMMENT 'User ID of the buyer who finally got the project.',
  `description` varchar(255) DEFAULT 'None' COMMENT 'Description of the project',
...
CREATE TABLE `seller` (
  ...
  `location` varchar(45) DEFAULT 'None' COMMENT 'Location of the seller',
  `job_title` varchar(100) DEFAULT 'None' COMMENT 'Job title of the seller',
  `company` varchar(45) DEFAULT 'None' COMMENT 'Company of the seller',
